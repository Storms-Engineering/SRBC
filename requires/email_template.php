<?php
$emailTempPt1 = '<html xmlns="https://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
<!--[if gte mso 9]><xml>
...
<title>Solid Rock Bible Camp</title>
  ...
  <tbody><tr>
    <td valign="top" align="center"><table class="em_main_table" style="width:700px;" width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <!--Content Text Section-->
                 <tr>
          <td style="padding:35px 70px 30px;" class="em_padd" valign="top" bgcolor="#3f7856" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
              <tbody><tr>
				<td style="font-family:\'Open Sans\', Arial, sans-serif; font-size:16px; line-height:30px; color:#ffffff;" valign="top">';
...
<tbody><tr>
<td style="padding-bottom:16px;font-family:\'Open Sans\', Arial, sans-serif; font-size:16px;" valign="top" align="center"><table cellspacing="0" cellpadding="0" border="0" align="center">
  <tbody><tr>
	<td style="padding:10px;" class="mobile-block">Solid Rock Bible Camp<br>
	36251 Solid Rock Rd. #1<br>
	Soldotna, AK 99669<br></td>
...
© 2020 Solid Rock Ministries. All Rights Reserved.<br>
</td>
</tr>
</tbody></table></td>
</tr>
